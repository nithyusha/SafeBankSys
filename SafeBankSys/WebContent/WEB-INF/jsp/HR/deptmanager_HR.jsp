...
<body>
	...
	<table>
		...
		<tr>
			<td><a href="${pageContext.request.contextPath}/HR/viewAllTransactions" >View All Transactions</a></td>
			
		</tr>
		<tr>
			<td><a href="${pageContext.request.contextPath}/HR/viewAllPendingTransForDeptMgr" >Authorize Transactions</a></td>
			
		</tr>
		<tr>
			<td><a href="${pageContext.request.contextPath}/HR/getEmployeeDetailsForm" >Get Employee Details</a></td>
