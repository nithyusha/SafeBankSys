...
<body>
	...
	<table>
		...
		<tr>
			<td><a href="${pageContext.request.contextPath}/TM/viewAllTransactions" >View All Transactions</a></td>
			
		</tr>
		<tr>
			<td><a href="${pageContext.request.contextPath}/TM/viewAllPendingTransForDeptMgr" >Authorize Transactions</a></td>
			
		</tr>
		<tr>
			<td><a href="${pageContext.request.contextPath}/salesTM/getEmployeeDetailsForm" >Get Employee Details</a></td>
