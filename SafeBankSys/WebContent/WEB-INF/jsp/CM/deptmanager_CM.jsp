...
<body>
	...
	<table>
		...
		<tr>
			<td><a href="${pageContext.request.contextPath}/CM/viewAllTransactions" >View All Transactions</a></td>
			
		</tr>
		<tr>
			<td><a href="${pageContext.request.contextPath}/CM/viewAllPendingTransForDeptMgr" >Authorize Transactions</a></td>
			
		</tr>
		<tr>
			<td><a href="${pageContext.request.contextPath}/CM/getEmployeeDetailsForm" >Get Employee Details</a></td>
