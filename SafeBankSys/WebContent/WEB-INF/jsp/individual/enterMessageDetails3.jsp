		...
		<div class="row">
			...
			<div class="span9">
				<form:form method="GET" commandName="certificateFormBean"
					action="${pageContext.request.contextPath}/individual/verifyCertificate">
				...
				<div style="font-size: 15px; color: green;">
					...
					<div align = "left"><h4>Re-confirm The Sender Details To Get His/Her Certificate Verified </h4></div>
					...
					<div class="control-group" align="left">
						<input type="submit" value="Verify Certificate" name="Send Certificate" class="btn btn-success btn-sm" />
					</div>
				</form:form>
			</div>
		</div>
